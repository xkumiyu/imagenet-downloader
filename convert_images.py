...
def main():
    ...
    parser.add_argument(
        '--input', '-i', default='images/original/', type=pathlib.Path)
    parser.add_argument(
        '--output', '-o', default='images/resized/', type=pathlib.Path)
    parser.add_argument(
        '--min_size',
        help=
        'resize side of min(H, W) to min_size, aspect ratio of another side is maintained.'
    )
